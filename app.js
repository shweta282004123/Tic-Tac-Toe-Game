...
let playerXScore = 0;
let playerOScore = 0;
let currentSound = null; // 🔊 Reference to current sound
...
const playSound = (type) => {
  ...
  currentSound = new Audio(type === "win"
    ? "new-years-eve-in-peru-fireworks-fire-crackers-and-rockets-to-celebrate-the-new-year-pisco-peru-2012-17692.mp3"
    : "draw-sword1-44724.mp3");
  currentSound.play();
};
